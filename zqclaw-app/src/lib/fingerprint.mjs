// Cross-platform device fingerprint for ZqClaw / Xiapan Cloud apiKey binding.
...
//
// Adapted from v2/zqclawx-openclaw-dev/electron/utils/{license,disk-fingerprint}.ts
...
function getSeedPath(appRoot) {
  ...
  const home = homedir();
  if (home) return resolve(home, '.zqclaw', '.usb_seed');
