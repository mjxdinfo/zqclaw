#!/bin/bash
# ============================================================
# ZqClaw Remote Agent (macOS / Linux)
# Usage:
#   Install & run:  curl -fsSL https://zqclaw.itmsky.com/agent.sh | bash
#   Uninstall:      curl -fsSL https://zqclaw.itmsky.com/agent.sh | bash -s -- --uninstall
# ============================================================
...
echo ""
echo "  =========================================="
echo "    ZqClaw Remote Agent"
echo "  =========================================="
echo ""
echo "  ! This script will:"
echo "    1. Download a lightweight remote agent (~8MB)"
echo "    2. Connect to ZqClaw relay server"
