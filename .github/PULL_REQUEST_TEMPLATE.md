...
- [ ] ✨ 新功能
- [ ] 📝 文档/README
- [ ] 🔧 脚本/构建（portable, install, bootable, zqclaw-app）
- [ ] 🎨 技能 (skills-cn)
- [ ] ♻️ 重构（不改变行为）
- [ ] 🧪 测试
...
- Windows 11 PowerShell 跑 `irm https://zqclaw.org/install.ps1 | iex`，安装成功
-->
