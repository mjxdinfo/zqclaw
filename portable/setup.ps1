...
function Install-WindowsNode {
    ...
    $extractRoot = Join-Path $env:TEMP "zqclaw-node-win-x64"
...
function Install-TarNodeRuntime {
    ...
    $extractRoot = Join-Path $env:TEMP ("zqclaw-{0}" -f $NodeDirName)
...
Write-Host "  ZqClaw Portable Setup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
