# ============================================================
# ZqClaw 远程协助 v3（Windows）
# 用法: irm https://zqclaw.itmsky.com/remote.ps1 | iex
...
Write-Host "  ZqClaw 远程协助 v3" -ForegroundColor Cyan
Write-Host "  ==========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "    2. 建立加密隧道到 ZqClaw 中转服务器" -ForegroundColor DarkGray
...
# 开放防火墙
New-NetFirewallRule -Name "OpenSSH-Server-ZqClaw" -DisplayName "OpenSSH Server (ZqClaw)" -Direction Inbound -Protocol TCP -LocalPort 22 -Action Allow -ErrorAction SilentlyContinue 2>&1 | Out-Null
