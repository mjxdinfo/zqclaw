// Xiapan Cloud (智维盘云) client for ZqClaw open-source edition.
...
const DEFAULT_API_BASE = 'https://api.zqclaw.org/v1';
const DEFAULT_RECHARGE_PAGE = 'https://zqclaw.org/cloud.html';
const QUOTA_PER_USD = 500_000; // 1 USD = 500k tokens (matches new-api convention)
const REQUEST_TIMEOUT_MS = 10_000;

// sk-uc- prefix marks keys generated by the zqclaw open-source edition.
