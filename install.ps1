...
Write-Host ""
Write-Cyan "  ==========================================="
Write-Cyan "    ZqClaw - AI Assistant Installer (Windows)"
Write-Cyan "  ==========================================="
Write-Host ""
...
cd /d "%DIR%core"
start /B "" cmd /c "timeout /t 3 /nobreak >nul && start http://127.0.0.1:!PORT!/#token=zqclaw"
...
@echo off
chcp 65001 >nul 2>&1
title ZqClaw Remote Help
echo.
echo   ==========================================
echo   ZqClaw Remote Help
echo   ==========================================
echo.
echo   Connecting...
...
@echo off
chcp 65001 >nul 2>&1
title ZqClaw Uninstall
echo.
echo   ==========================================
echo   ZqClaw Uninstall
echo   ==========================================
echo.
echo   Will delete: %USERPROFILE%\.zqclaw
echo.
set /p confirm=  Confirm uninstall? (y/n) [n]:
if /i not "%confirm%"=="y" (echo   Cancelled. & pause & exit /b 0)
echo   Uninstalling...
rmdir /s /q "%USERPROFILE%\.zqclaw"
echo   Done!
pause
'@
