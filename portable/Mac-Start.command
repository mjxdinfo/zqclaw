#!/bin/bash
# ============================================================
# ZqClaw - Portable AI Agent (macOS)
...
if [ ! -d "$CORE_DIR/node_modules" ]; then
    ...
    echo "  TIP: re-download zqclaw-portable-*.zip with bundled deps."
    cd "$CORE_DIR"
...
echo -e "  ${GREEN}════════════════════════════════${NC}"
echo -e "  ${GREEN}🦞 ZqClaw is running!${NC}"
echo -e "  ${GREEN}   Dashboard:     http://127.0.0.1:$PORT/#token=zqclaw${NC}"
